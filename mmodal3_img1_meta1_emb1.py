...
def main():
    ...
    # Dataset
    train_dataset = multimodal3_Dataset(df_train, proc_images, proc_embeddings, proc_metadata, proc_target)
    val_dataset = multimodal3_Dataset(df_val, proc_images, proc_embeddings, proc_metadata, proc_target)
    ...
    def objective(trial):
        ...
        model = multi_modal3_class2(metadata_input = 20, embeddings_input = 384, dropout_rate = 0.75)
    ...
    study.set_user_attr('comments', 'Multimodal: ResNet18 pre + fcnn_pca + metadata') # CONFIG !!!
