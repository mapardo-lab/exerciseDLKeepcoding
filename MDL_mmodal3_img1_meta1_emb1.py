...
def main():
    ...
    proc = {
        ...
        'transform_embeddings': EmbeddingText('shortDescription', 'all-MiniLM-L6-v2'),
        'transform_metadata': ColumnTransformer(
            transformers=[
    ...
    proc_to_fit = ['transform_metadata']
