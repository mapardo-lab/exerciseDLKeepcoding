...
def main():
    ...
    study = optuna.create_study(
        ...
        study_name='resnet18_layer4_images1_da1', ## study_name CONFIG!!!
    ...
    study.set_user_attr('script', 'resnet18_layer4_images1_da1.py')
    ...
    study.set_user_attr('description', 'ResNet18 with pretrained weigths with optimization for layer4. Last layer changed to two levels classification. Basic data augmentation.')
