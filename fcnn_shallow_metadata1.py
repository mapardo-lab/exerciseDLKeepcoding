...
from utilsProc import process_data, set_random_seed, get_object_info, get_column_transformer_info
...
def main():
    ...
    def objective(trial):
        ...
        model = FCNN_shallow(20, num_classes = 2, dropout_rate = dropout_rate) # Optimized parameter dropout_rate
    ...
    study.set_user_attr('comments', 'FCNN shallow for metadata')
